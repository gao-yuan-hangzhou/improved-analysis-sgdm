...
momentum_values = [args.momentum_val] * 3 
print("c1 = {}, c2 = {}".format(c1, c2))
print("alpha = {}, beta = {}".format(alpha_values, beta_values))
print("lr_values = {}, momentum_values = {}".format(lr_values, momentum_values))

logdir = os.path.join("logs", "sgdm_c1-{}-c2-{}-momentum_val-{}-seed-{}".format(c1, c2, args.momentum_val, args.seed)) # directory for saving running log and plot
print(args)
print(logdir)
