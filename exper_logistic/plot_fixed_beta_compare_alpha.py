...
param_list = [(xx, beta) for xx in (0.1, 0.2, 0.5, 0.8, 1.0, 1.5)]
...
fig.legend(handles, labels, bbox_to_anchor=(0.53, 0.98), labelspacing=0.1, columnspacing=1.0, ncol=1)
...
# save...
plt.savefig("logistic_fixed_alpha_beta_{}.pdf".format(str(beta)), bbox_inches="tight")