...
parser.add_argument('--lr', default=0.001, type=float, help='learning rate') # 0.0001
...
# if using our method
print("========== Using our lr & mom schedule!! ==========")
...
# c1, c2 = 5, 1 被 baseline 0.9 beat了
# c1, c2 = 5, 2
c1, c2 = 2, 1
...
alpha_values = [c1/xx for xx in stage_lengths]
beta_values = [c2/(c2+xx) for xx in alpha_values]
# tranlate them to pytorch parameters
...
args.logdir = "logs/sgdm-schedule_id-{}-seed-{}".format(args.schedule_id, args.seed)
...
lr_curr, momentum_curr = lr_values[0], momentum_values[0] # first 5 epochs
...
for epoch in range(1, total_num_epochs+1):
    ...
    print("Using SGDM! schedule_id = {}, epoch = {}, current epoch using lr = {}, momentum = {}".format(args.schedule_id, epoch, lr_curr, momentum_curr))
