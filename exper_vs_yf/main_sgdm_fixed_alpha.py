...
args.logdir = "logs/sgdm-alpha-{}-momentum-{}-seed-{}".format(args.alpha, 0.9, args.seed)
...
for epoch in range(1, total_num_epochs+1):
    ...
    print("Using SGDM! alpha = {}, epoch = {}, current epoch using lr = {}, momentum = {}".format(args.alpha, epoch, lr_curr, momentum_curr))
